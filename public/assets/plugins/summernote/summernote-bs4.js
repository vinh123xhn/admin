...
(function (global, factory) {
  ...
  var Renderer = /** @class */ (function () {
      ...
      Renderer.prototype.render = function ($parent) {
          ...
          if (this.children) {
              var $container_1 = $node.find('.note-child-category-container');
  ...
  var popover = renderer.create([
      ...
      '  <div class="arrow"/>',
      '  <div class="popover-content note-child-category-container"/>',
      '</div>',
  ...
  var WrappedRange = /** @class */ (function () {
      ...
      WrappedRange.prototype.normalize = function () {
          ...
          var getVisiblePoint = function (point, isLeftToRight) {
              ...
              //  - case 06. if the point is on the block node and there is no child-category
      ...
      /**
       * wrap inline nodes which child-category of body with paragraph
       *
       * @return {WrappedRange}
       */
