...
function prependToElement(parent, content) {
    ...
    var afterEl = parent.firstChild || null; // if no firstChild, will append to end, but that's okay, b/c there were no child-category
        ...
        if (buttonStr) {
            buttonStr.split(' ').forEach(function (buttonGroupStr, i) {
                ...
                if (groupChildren.length > 1) {
                    ...
                    appendToElement(sectionEl, groupChildren); // 1 or 0 child-category
                }
            });
        }
        return sectionEl;
