...
@section('redirect_to_list')
    <a role="button"href="{{route('admin.image-launcher.form.get')}}">
        Thêm mới
    </a>
@endsection
@section('content')
    ...
    <div class="col-md-10">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{route('admin.image-launcher.form.post')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="link" placeholder="Đường dẫn bài viết" class="form-control" value="{{old('link')}}">
                                @error('link')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
