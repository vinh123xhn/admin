...
@section('custom-header')
    <title>{{empty($page) ? $detail->title . " | Hiệp Khách Giang Hồ - Yulgang Origin VTC" : "Hướng dẫn | Hiệp Khách Giang Hồ - Yulgang Origin VTC"}}</title>
    <meta name="keywords" content="{{keywords()}}">
    <meta name="description" content="{{empty($page) ? $detail->title . " | Hiệp Khách Giang Hồ - Yulgang Origin VTC, tựa game kiếm hiệp huyền thoại, đã trở lại với các hệ phái mới và các sự kiện độc quyền. Tải và chơi ngay hôm nay." : "Hướng dẫn | Hiệp Khách Giang Hồ - Yulgang Origin VTC, tựa game kiếm hiệp huyền thoại, đã trở lại với các hệ phái mới và các sự kiện độc quyền. Tải và chơi ngay hôm nay."}}" />
    <meta property="og:locale" content="vi_VN" />
    <meta property="og:site_name" content="Hiệp Khách Giang Hồ - Yulgang Origin VTC" />
    <meta property="og:title" content="{{empty($page) ? $detail->title . " | Hiệp Khách Giang Hồ - Yulgang Origin VTC" : "Hướng dẫn | Hiệp Khách Giang Hồ - Yulgang Origin VTC"}}" />
            ...
            <div class="section-content">
                <div class="container overflow-hidden">
                    <div class="main-s1 d-flex justify-content-start">
                        @include('huong-dan.menu')
                        <div class="main-s1-right">
                            <div class="lists-hd-m d-block d-lg-none">
                                <div class="d-flex justify-content-around align-items-center">
                                    <h4><img src="{{asset('./assets/homepage/images/label-huongdan.png')}}" class="img-fluid" alt="" /></h4>
                                                ...
                                                <ul class="dropdown-menu">
                                                    @foreach($item['post'] as $i => $post)
                                                        <li><a role="button"style="max-width: 300px; /* Đặt chiều rộng của phần tử */
                                                            white-space: nowrap;
                                                            overflow: hidden;
                                                            text-overflow: ellipsis;" class="dropdown-item" href="{{route('huong_dan_detail', ['post' => $post['title_domain']])}}" title="{{$post['title']}}">{{$post['title']}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                        </div>
